...
import * as KanbanTools from "./kanban";
...
export const CORE_TOOLS = [
  ...
  KanbanTools.KANBAN_TASK_CREATE,
  KanbanTools.KANBAN_TASK_LIST,
  KanbanTools.KANBAN_TASK_UPDATE,
  KanbanTools.KANBAN_TASK_DELETE,
