...
/**
 * Non-throwing variant. Returns null outside a `ThreadManagerProvider`. Use
 * this for navigation-only consumers that should work everywhere but only need
 * the manager for thread mutations.
 */
