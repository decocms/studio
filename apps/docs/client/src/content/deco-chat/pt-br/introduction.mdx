...
**Mais detalhes:** [Local: Docker Compose](/deco-chat/pt-br/studio/deploy/local-docker-compose)
...
**Mais detalhes:** [Kubernetes: Helm Chart](/deco-chat/pt-br/studio/deploy/kubernetes-helm-chart)

## Aprenda o Studio (conceitos + superfícies do produto)

- **[Visão geral](/deco-chat/pt-br/studio/overview)**
- **[Quickstart](/deco-chat/pt-br/studio/quickstart)**
- **[Conceitos](/deco-chat/pt-br/studio/concepts)**
- **[MCP Servers](/deco-chat/pt-br/studio/mcp-servers)**
- **[MCP Agents](/deco-chat/pt-br/studio/mcp-gateways)**
- **[API Keys](/deco-chat/pt-br/studio/api-keys)**
- **[Monitoring](/deco-chat/pt-br/studio/monitoring)**
- **[API Reference](/deco-chat/pt-br/studio/api-reference)**

<Callout type="warning">
  **Divisão da documentação (guia rápido):**

  - **O Studio** → Self-hosting, deploy e operação do Studio (recomendado).
