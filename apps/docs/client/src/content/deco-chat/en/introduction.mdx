...
**More details:** [Local: Docker Compose](/deco-chat/en/studio/deploy/local-docker-compose)
...
**More details:** [Kubernetes: Helm Chart](/deco-chat/en/studio/deploy/kubernetes-helm-chart)

## Learn Studio (concepts + product surfaces)

- **[Studio Overview](/deco-chat/en/studio/overview)**
- **[Quickstart](/deco-chat/en/studio/quickstart)**
- **[Concepts](/deco-chat/en/studio/concepts)**
- **[MCP Servers (Connections)](/deco-chat/en/studio/mcp-servers)**
- **[MCP Agents](/deco-chat/en/studio/mcp-gateways)**
- **[API Keys](/deco-chat/en/studio/api-keys)**
- **[Monitoring](/deco-chat/en/studio/monitoring)**
