...
To put a connection to work, attach it to an [agent](/en/studio/agents): inside the project, choose **Settings** from the sidebar and pick the connection (and the specific tools from it) you want this agent to use.
