...
- Which agent or project the call came from
...
When something breaks, you can open the monitoring tab and see exactly what happened — what inputs were sent, what error came back, when it occurred. No SSH, no log files, no guessing.
