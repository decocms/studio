...
When the agent is running with a local code-editor runtime, **Open in Finder/File Explorer**, **Open in VSCode**, and **Open in Cursor** buttons provide one-click access to the repo on your machine. The same options are also available in the preview tab's three-dot (⋯) menu.
