...
- **Super Agent** — _"Runs in an agent sandbox."_ The agent executes in a sandbox managed by Studio. This is the default, always available, with nothing to install.
...
- **Super Agent** — the Super Agent harness, running on your desktop
...
- **From Super Agent** — Super Agent can hand a task to a specialist agent in a subtask (see [Super Agent](/en/studio/decopilot/overview))
- **From your own code** — call its MCP endpoint directly

---

**Next:** Attach tools via [Connections](/en/studio/connections), run agents unattended with [Automations](/en/studio/automations), or see [Super Agent](/en/studio/decopilot/overview) for how Studio's built-in assistant uses agents.
