...
- **Sidebar — project views.** In **Layout**, choose whether Home, Deco Score, Tasks, Site Editor, Automations, and any available Assets, Hosting, E2E, Deco Analytics, Monitor, or pinned MCP-app view appears here. Selecting one opens it as the main view; these destinations do not also appear as top-level panel tabs.
