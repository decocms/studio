...
**Library** is a file browser for your organization's shared filesystem — reachable from **Library** in the organization sidebar. It's the human-facing window onto the same files your agents read and write: anything an agent saves to the org filesystem shows up here, and anything you drop here is available to your agents.
