...
<Callout type="info">
  For how agents use these folders at runtime — recording durable knowledge, reading chat attachments, writing run output — see [Super Agent → Overview](/en/studio/decopilot/overview#built-in-tools).
</Callout>
