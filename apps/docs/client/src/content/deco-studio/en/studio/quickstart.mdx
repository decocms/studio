...
- **Right** — the project's main view. Home, Reports, Tasks, Site Editor, and any enabled project tools are durable destinations in the sidebar. Site Editor contains its own Preview, Content, and Code tabs.
