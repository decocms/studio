...
| **Desktop app (Mac)** | Native macOS app — install via `curl -fsSL https://studio.decocms.com/install.sh \| sh`, or click **Install on Mac** in the account menu (bottom of the sidebar) |
