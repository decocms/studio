...
deco Studio is where you build agents, connect them to tools, run them on schedules or events, and see exactly what they're doing — and what it costs. Self-host or use the cloud. Built on the [Model Context Protocol](https://modelcontextprotocol.io).
...
Every tool call your agents make is logged automatically — who called it, when, what came back, how long it took, what it cost. One place to debug, audit, and track costs.
