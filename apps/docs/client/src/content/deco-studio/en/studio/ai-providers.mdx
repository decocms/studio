---
title: AI Providers
description: Connect the AI models that power Super Agent and your agents
icon: Sparkles
---
...
**AI Providers** are the AI model services that power [Super Agent](/en/studio/decopilot/overview) and your agents. You connect a provider once at the organization level, and all your agents use it from there.
...
Configure these once under **Settings → AI Providers → Default models**. When an agent or Super Agent picks a tier, it routes to the model you set. Change a default and every agent picks up the new model immediately — no per-agent reconfiguration.
...
<Callout type="info">
New organizations get Deco AI Gateway credits out of the box — you can start using Super Agent and your agents without configuring anything. See [Super Agent](/en/studio/decopilot/overview) or [API Keys](/en/studio/api-keys) for managing programmatic access to Studio itself.
</Callout>
