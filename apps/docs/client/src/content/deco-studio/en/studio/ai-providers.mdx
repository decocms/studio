...
| **OpenAI** | Direct OpenAI key — GPT-4, GPT-5, etc. |
| **LiteLLM** | Connect a LiteLLM gateway your team manages |
| **Ollama** | Run open-source models on your own machine |
| **LM Studio** | Open models running through LM Studio |
| **vLLM** | Connect to your team's self-hosted vLLM server |
| **Custom OpenAI-compatible** | Bring your own model server (advanced) |
...
**Local endpoint** — for Ollama, LM Studio, vLLM, LiteLLM, or custom OpenAI-compatible servers: paste the base URL where Studio can reach the server.
