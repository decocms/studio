...
You can check your remaining gateway credit and top up directly from **Settings → AI Providers**. Each top-up request is capped at $10,000 (1,000,000 cents) — for larger amounts, top up multiple times.
...
| **LLMAPI** | One API key, 400+ models across every provider |
