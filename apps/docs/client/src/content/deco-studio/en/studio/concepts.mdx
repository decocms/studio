...
- **AI Provider** — a configured AI model (Anthropic, Google, OpenRouter, or the Deco AI Gateway) that powers your agents and Super Agent. See [AI Providers](/en/studio/ai-providers).
...
When you open Studio you land on the **home screen**: a single chat composer — _"What's on your mind?"_ — backed by **Super Agent**, Studio's built-in assistant, plus a customizable grid of shortcuts to your agents. Just start typing to get going; the conversation you start is saved under **Super Agent** in the sidebar.
...
- **Threads** — your recent conversations, grouped by agent (Super Agent's live under "Super Agent"). Click one to resume it; start a new one from Home or the **+** / "Browse agents" button.
