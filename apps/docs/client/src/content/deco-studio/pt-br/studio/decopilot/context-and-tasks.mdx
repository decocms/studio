...
description: Como o Super Agent gerencia memory e como usar subtasks para trabalhos pesados
icon: Layers
---

import Callout from "../../../../../components/ui/Callout.astro";

O Super Agent organiza o trabalho como **tasks** (suas conversas) e **subtasks** (conversas paralelas focadas que se ramificam). Entender como elas compartilham memory ajuda você a fazer mais em uma única sessão.

## O que é uma task?

Uma **task** é sua conversa com o Super Agent — onde você conversa, o Super Agent usa tools e o trabalho é feito. Toda task roda em um escopo (org ou agent — veja [Visão geral](/pt-br/studio/decopilot/overview)) que determina quais instruções e tools são carregadas.
...
Quando uma task começa, o Super Agent carrega:
...
Conforme a conversa cresce, o histórico ocupa mais espaço. Quando fica muito cheio, o Super Agent automaticamente resume as partes mais antigas e mantém o resumo no lugar — liberando espaço sem perder o context importante.
...
- **Acima de 80% cheio** — o Super Agent compacta automaticamente o histórico da conversa
...
**Seja seletivo com tools** — o Super Agent carrega tools na memory. Não habilite tools que você não precisa para a task atual.
