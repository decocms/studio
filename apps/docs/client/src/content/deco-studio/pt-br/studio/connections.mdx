...
Para colocar uma connection em uso, anexe-a a um [agent](/pt-br/studio/agents): dentro do projeto, escolha **Settings** na sidebar e selecione a connection (e as tools específicas dela) que você quer que esse agent use.
