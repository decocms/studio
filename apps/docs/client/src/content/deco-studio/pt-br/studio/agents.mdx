...
- **Super Agent** — _"Roda em um agent sandbox."_ O agent executa em um sandbox gerenciado pelo Studio. Este é o padrão, sempre disponível, sem nada para instalar.
...
- **Super Agent** — o harness do Super Agent, rodando no seu desktop
...
- **Pelo Super Agent** — o Super Agent pode passar uma tarefa para um agent especialista em uma subtask (veja [Super Agent](/pt-br/studio/decopilot/overview))
- **Pelo seu próprio código** — chame seu endpoint MCP diretamente

---

**Próximo:** Anexe tools via [Connections](/pt-br/studio/connections), execute agents sem supervisão com [Automations](/pt-br/studio/automations), ou veja [Super Agent](/pt-br/studio/decopilot/overview) para entender como o assistente integrado do Studio usa agents.
