...
- **Esquerda — chat.** Converse com o agent em linguagem natural; ele usa as tools anexadas para fazer o trabalho. Suas mensagens e threads passadas com este agent ficam aqui. Acima do input está o **model picker**.
...
Um agent baseado em Git também mostra um **branch selector** e um indicador de **status do sandbox** enquanto seu ambiente inicializa.
...
Os chats do Studio rodam com o **Decopilot**. Quando um agent é respaldado por
código, o Decopilot usa o **agent sandbox** gerenciado do agent para operações
de file, shell, git e preview. Não há runtime ou harness para configurar.
