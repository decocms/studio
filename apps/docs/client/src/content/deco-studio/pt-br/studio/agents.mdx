...
Quando o agent está rodando com um runtime local de code-editor, os botões **Open in Finder/File Explorer**, **Open in VSCode** e **Open in Cursor** dão acesso ao repositório na sua máquina com um clique. As mesmas opções também ficam disponíveis no menu de três pontos (⋯) da aba de preview.
