...
- **Editing** — preferências de edição de conteúdo: **Compact descriptions** (mostrar as descrições dos campos como tooltips em vez de texto inline) e **Auto-open editor** (abrir o CMS automaticamente quando a aba Preview do agent carrega).
