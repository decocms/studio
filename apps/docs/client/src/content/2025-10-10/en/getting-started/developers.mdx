...
**Note:** If you're not inside a deco project folder or haven't initialized the CLI in your editor, you'll need to install it globally using `npx decocms` in order to get access to deco commands
