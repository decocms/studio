...
**Note:** If you're not inside a deco project folder or haven't initialized the CLI in your editor, you can run CLI commands directly with `npx decocms <command>`
