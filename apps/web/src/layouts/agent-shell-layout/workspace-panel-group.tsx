/**
 * Persistent desktop workspace: ChatPanel | MainPanel.
 *
 * Each panel is one full-height card. Chat owns a `PanelHeader`; every routed
 * Main surface owns its own `Main.Topbar`. Chat toggles from the sidebar;
 * when Main is hidden, its recovery control appears at Chat's trailing edge.
 */
