        ...
        >
          ...
          <div className="ml-auto flex shrink-0 items-center gap-2">
              ...
              {VALID_LOCALES.map((locale) => {
                ...
                return (
                  <button
                    ...
                    className="h-8 classic:rounded-full compact:rounded-lg px-3 text-xs font-medium uppercase transition-colors"
                    style={{
            ...
            {sessionUser && (
              <div className="relative" ref={userMenuOutsideRef}>
                <button
                  ...
                  className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden classic:rounded-full compact:rounded-lg border text-sm font-medium transition-transform hover:scale-[1.03]"
                  style={{
                    borderColor: DECK.cardBorder,
            ...
            <button
              ...
              className="inline-flex h-9 items-center classic:rounded-full compact:rounded-lg px-5 text-sm font-medium transition-transform hover:scale-[1.03]"
        ...
        {isCtaSlide ? (
          <>
            ...
            <button
              ...
              className="grid h-12 w-12 shrink-0 place-items-center classic:rounded-full compact:rounded-lg border lg:hidden"
              style={{
            ...
            <button
              type="button"
              onClick={(e) => handleShareClick(e, slide)}
              className="ml-auto hidden h-12 items-center gap-2 classic:rounded-full compact:rounded-lg border px-6 text-sm font-medium lg:inline-flex"
              style={{
          ...
          <>
              ...
              {slide.methodology ? (
                <span className="group relative">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 classic:rounded-full compact:rounded-lg px-2.5 py-2 text-[13px] transition-colors hover:bg-black/5 sm:text-sm"
                  ...
                  {feedbackSent ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 self-start classic:rounded-full compact:rounded-lg px-4 py-2 text-sm font-medium transition-opacity disabled:opacity-40"
                        style={{
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={(e) => handleShareClick(e, slide)}
                className="inline-flex h-12 w-12 items-center justify-center gap-2 classic:rounded-full compact:rounded-lg border font-medium sm:w-auto sm:px-6 sm:text-sm"
                style={{
                  borderColor: DECK.inputBorder,
                  color: DECK.ink,
                  background: DECK.surface,
