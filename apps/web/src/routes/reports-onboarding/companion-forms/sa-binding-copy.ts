...
/** reports binding requirement types → provider codes. Only these
...
export const BIND_PROVIDER_COPY: Record<BindProvider, BindProviderCopy> = {
  ga4: {
    ...
    consoleLinkKey: "reportsOnboarding.saBinding.ga4.openConsole",
    steps: [
      "reportsOnboarding.saBinding.ga4.step1",
      "reportsOnboarding.saBinding.ga4.step2",
      "reportsOnboarding.saBinding.ga4.step3",
    ],
    resourceLabelKey: "reportsOnboarding.saBinding.ga4.resourceLabel",
    resourcePlaceholderKey:
      "reportsOnboarding.saBinding.ga4.resourcePlaceholder",
    resourceHintKey: "reportsOnboarding.saBinding.ga4.resourceHint",
  },
  gsc: {
    label: "Google Search Console",
    consoleUrl: "https://search.google.com/search-console",
    consoleLinkKey: "reportsOnboarding.saBinding.gsc.openConsole",
    steps: [
      "reportsOnboarding.saBinding.gsc.step1",
      "reportsOnboarding.saBinding.gsc.step2",
      "reportsOnboarding.saBinding.gsc.step3",
    ],
    resourceLabelKey: "reportsOnboarding.saBinding.gsc.resourceLabel",
    resourcePlaceholderKey:
      "reportsOnboarding.saBinding.gsc.resourcePlaceholder",
    resourceHintKey: "reportsOnboarding.saBinding.gsc.resourceHint",
  },
};
...
export function remediationFor(
  ...
  switch (reason) {
    case "no-access":
      return {
        titleKey: "reportsOnboarding.saBinding.remediation.noAccess.title",
        stepKeys:
          provider === "ga4"
            ? [
    ...
    case "no-web-stream":
      ...
      return {
        titleKey: "reportsOnboarding.saBinding.remediation.noWebStream.title",
        stepKeys: [
    ...
    case "no-match":
      return {
        titleKey: "reportsOnboarding.saBinding.remediation.noMatch.title",
        stepKeys:
          provider === "ga4"
            ? [
    ...
    case "resource_already_bound":
      return {
        titleKey: "reportsOnboarding.saBinding.remediation.alreadyBound.title",
        stepKeys: [
    ...
    default:
      return {
        titleKey: "reportsOnboarding.saBinding.remediation.unknown.title",
        stepKeys: [
