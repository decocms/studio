  ...
  return (
    <div className="relative flex flex-col gap-8 text-white">
      ...
      <blockquote className="text-lg font-medium leading-[1.45] lg:text-xl">
        “{t("routes.reportsOnboarding.connectModal.quote")}”
      </blockquote>
      <figcaption className="flex items-center gap-2.5">
        ...
        <span className="text-base font-medium">
          {t("routes.reportsOnboarding.connectModal.quoteAuthor")}
        </span>
      </figcaption>
    </div>
  );
...
export function ConnectTrustSignals() {
  ...
  const items = [
    {
      Icon: ReverseLeft,
      label: t("routes.reportsOnboarding.connectModal.trustRevoke"),
    },
    {
      Icon: Lock01,
      label: t("routes.reportsOnboarding.connectModal.trustEncrypted"),
    },
    {
      Icon: SlashCircle01,
      label: t("routes.reportsOnboarding.connectModal.trustNeverSold"),
    },
  ];
  return (
