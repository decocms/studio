...
function ScheduleMeetingCta({
  ...
  return (
    ...
    >
      ...
      >
        {t("routes.reportsOnboarding.scheduleMeeting.scheduleButton")}
...
function TeamAvatars({ size = 72 }: { size?: number }) {
  const t = useT();
  const alt = t("routes.reportsOnboarding.scheduleMeeting.expertAlt");
        ...
        <div className="px-8 pb-8">
          ...
          <div className="grid gap-1.5">
            <h2 className="text-lg font-medium leading-6 text-foreground">
              {t("routes.reportsOnboarding.scheduleMeeting.headline")}
            </h2>
            <p className="text-sm leading-5 text-muted-foreground">
              {t("routes.reportsOnboarding.scheduleMeeting.body")}
            </p>
          </div>
