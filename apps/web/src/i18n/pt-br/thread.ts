...
export const thread = {
  ...
  "thread.branchPicker.searchDrafts": "Pesquisar rascunhos…",
  "thread.branchPicker.searchDraftsOpen": "Pesquisar rascunhos",
  "thread.branchPicker.searchDraftsClose": "Limpar pesquisa",
  "thread.branchPicker.noDraftsFound": "Nenhum rascunho encontrado.",
