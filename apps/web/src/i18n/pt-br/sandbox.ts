...
export const sandbox = {
  ...
  "sandbox.fileExplorer.backToFiles": "Voltar para os arquivos",
  ...
  "sandbox.postToolbar.updateCategory": "Atualizar categoria",
  "sandbox.preview.backToPreview": "Voltar para a prévia",
