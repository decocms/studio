...
export const sidebar = {
  ...
  "sidebar.scope.allProjects": "Todos os agentes",
  "sidebar.picker.ariaLabel": "Organiza\u00e7\u00e3o e agente: {name}",
  "sidebar.picker.backToOrg": "Voltar para {name}",
  "sidebar.picker.projectInOrg": "{project} — {org}",
  "sidebar.picker.currentTag": "atual",
  "sidebar.picker.currentOrgHeading": "{name} \u00b7 atual",
  "sidebar.picker.newOrganization": "Nova organização",
  "sidebar.picker.newProject": "Novo agente",
  ...
  "sidebar.picker.projectsHeading": "Agentes",
  "sidebar.picker.searchPlaceholder":
    "Buscar organiza\u00e7\u00f5es e agentes\u2026",
  "sidebar.picker.moreExist":
    "H\u00e1 mais agentes do que cabem aqui \u2014 continue digitando",
  "sidebar.picker.verbIdle": "Selecione uma linha para ver o que ela faz",
  "sidebar.picker.verbLeaves": "\u00b7 sai de {name}",
  "sidebar.picker.verbScope": "Abrir {name}",
