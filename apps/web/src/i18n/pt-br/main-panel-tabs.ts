...
export const mainPanelTabs = {
  ...
  "mainPanelTabs.hostingTab.noDomains": "Nenhum domínio personalizado configurado.",
  "mainPanelTabs.hostingTab.addDomain": "Adicionar domínio",
  "mainPanelTabs.hostingTab.addDomainTitle": "Vincular um domínio personalizado",
  ...
  "mainPanelTabs.analyticsTab.dataLoadError": "Não foi possível carregar esta visão.",
