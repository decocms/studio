...
export const settings = {
  ...
  "settings.board.title": "Quadro",
  "settings.board.saved": "Configurações do quadro salvas",
  "settings.board.saveFailed": "Falha ao salvar as configurações do quadro",
  "settings.board.columnsTitle": "Colunas",
  "settings.board.columnsDescription":
    "Renomeie, reordene ou adicione colunas ao quadro. Cada coluna mapeia para uma etapa, que é o que a automação dos agentes segue.",
  "settings.board.resetColumns": "Restaurar padrão",
  "settings.board.saveColumns": "Salvar colunas",
  "settings.board.addColumn": "Adicionar coluna",
  "settings.board.stageLabel": "Etapa:",
  "settings.board.moveColumnUpAriaLabel": "Mover coluna para cima",
  "settings.board.moveColumnDownAriaLabel": "Mover coluna para baixo",
  "settings.board.deleteColumnAriaLabel": "Deletar coluna",
  "settings.board.automationLabel": "Rodar agente na entrada",
  "settings.board.automationSuperAgent": "Super Agent",
  "settings.board.automationAgentUnknown": "Agente desconhecido",
  "settings.board.featuresTitle": "Recursos",
  "settings.board.featuresDescription":
    "Recursos opcionais de planejamento. Desligados por padrão para manter o quadro simples.",
  "settings.board.sprintsToggle": "Sprints",
  "settings.board.sprintsToggleDescription":
    "Planeje o trabalho em sprints semanais e filtre o quadro por sprint. Sprints são as semanas do calendário — escolha uma por tarefa, sem configuração.",
  "settings.board.releasesToggle": "Releases",
  "settings.board.releasesToggleDescription":
    "Agrupe tarefas concluídas em releases a partir do quadro.",
