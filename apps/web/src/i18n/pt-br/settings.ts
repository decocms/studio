...
export const settings = {
  ...
  "settings.jira.connectDescription":
    "Use um site do Jira Cloud e um API token, de preferência de uma conta de serviço com acesso ao projeto.",
  "settings.jira.siteLabel": "Site do Jira",
  "settings.jira.sitePlaceholder": "suaempresa.atlassian.net",
  "settings.jira.emailLabel": "E-mail da conta Atlassian",
  "settings.jira.emailPlaceholder": "voce@empresa.com",
  "settings.jira.tokenLabel": "API token",
  "settings.jira.tokenPlaceholder": "Cole seu token",
  ...
  "settings.boardColumns.instructionHelp":
    "O que o agente deve fazer com um card que chega aqui. O título e a descrição do card vão junto, então isto é a instrução, não a mensagem inteira.",
  ...
  "settings.apiKeys.cancelButton": "Cancelar",
  "settings.apiKeys.copied": "Copiado para a área de transferência",
  "settings.apiKeys.copyKey": "Copiar chave",
  "settings.apiKeys.createButton": "Criar chave",
  "settings.apiKeys.createdAt": "Criada em {date}",
  "settings.apiKeys.createdDescription":
    "Copie esta chave agora — ela não será mostrada novamente.",
  "settings.apiKeys.createdTitle": "Chave de API criada",
  "settings.apiKeys.creatingButton": "Criando…",
  "settings.apiKeys.deleteDescription":
    "Qualquer aplicação usando esta chave perderá acesso imediatamente. Isso não pode ser desfeito.",
  "settings.apiKeys.deleteKey": "Excluir chave",
  "settings.apiKeys.deleteTitle": 'Excluir "{name}"?',
  "settings.apiKeys.done": "Concluído",
  "settings.apiKeys.emptyDescription":
    "Crie uma chave para autenticar aplicações externas nesta organização.",
  "settings.apiKeys.emptyTitle": "Nenhuma chave de API ainda",
  "settings.apiKeys.failedToCreateKey": "Falha ao criar chave de API",
  "settings.apiKeys.failedToDeleteKey": "Falha ao excluir chave de API",
