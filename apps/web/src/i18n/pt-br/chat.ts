...
export const chat = {
  ...
  "chat.agentCreate.createAgent": "Criar projeto",
  "chat.agentCreate.created": "Projeto criado",
  "chat.agentCreate.creating": "Criando projeto",
  "chat.agentCreate.seeAgent": "Ver projeto",
  "chat.agentCreate.seeAgentLabel": "Ver projeto: {name}",
  "chat.agentIcons.claudeCode": "Claude Code",
  "chat.agentIcons.codex": "Codex",
  "chat.agentIcons.opencode": "OpenCode",
  "chat.agentList.agentsNoun": "projetos",
  "chat.agentList.couldntLoad": "Não foi possível carregar projetos",
  "chat.agentList.listAgents": "Listar projetos",
  "chat.agentList.loading": "Carregando projetos",
  "chat.agentList.multiAgents": "{count} projetos",
  "chat.agentList.noAgents": "Nenhum projeto ainda",
  "chat.agentList.noAgentsDesc":
    "Esta organização ainda não criou nenhum projeto.",
  "chat.agentList.oneAgent": "1 projeto",
  "chat.agentList.unavailable": "Lista de projetos indisponível",
  ...
  "chat.contextPanel.agentLabel": "Projeto",
  ...
  "chat.generic.tool.enableTool": "Ativar Ferramenta",
  "chat.generic.tool.glob": "Encontrar Arquivos",
  "chat.generic.tool.grep": "Buscar Conteúdo",
  "chat.generic.tool.openInAgent": "Abrir no Projeto",
  "chat.generic.tool.read": "Ler Arquivo",
  "chat.generic.tool.readPrompt": "Ler Prompt",
  "chat.generic.tool.readResource": "Ler Recurso",
  "chat.generic.tool.readToolOutput": "Ler Saída da Ferramenta",
  "chat.generic.tool.sandbox": "Executar Código",
  "chat.generic.tool.skill": "Carregar Skill",
  "chat.generic.tool.write": "Escrever Arquivo",
  ...
  "chat.fastPreview.chatNeedsSession":
    "O chat precisa de um sandbox de código por trás. A sessão continua neste branch e o CMS segue funcionando normalmente.",
  ...
  "chat.mentionAt.agentsDescription":
    "Mencione um projeto para transferir o trabalho",
  "chat.mentionAt.agentsTitle": "Projetos",
  ...
  "chat.noAiProviderEmptyState.headingDefault":
    "Seus projetos estão quase prontos",
  ...
  "chat.selectVirtualMcp.chooseAgentTooltip":
    "Escolha um projeto para conversar",
  "chat.selectVirtualMcp.createAgent": "Criar Projeto",
  "chat.selectVirtualMcp.creating": "Criando...",
  "chat.selectVirtualMcp.noAgentsFound": "Nenhum projeto encontrado",
  "chat.selectVirtualMcp.searchPlaceholder": "Pesquisar por um projeto...",
  "chat.selectVirtualMcp.selectAgent": "Selecionar Projeto",
