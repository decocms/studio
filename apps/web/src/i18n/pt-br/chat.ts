...
export const chat = {
  ...
  "chat.sessionTabs.newSession": "Novo chat nesta tarefa",
  "chat.taskPill.noTask": "Sem tarefa",
  "chat.taskPill.searchPlaceholder": "Buscar tarefas...",
  "chat.taskPill.noneFound": "Nenhuma tarefa encontrada.",
  "chat.taskPill.addThisChat": "Adicionar este chat ao quadro",
  "chat.taskPill.switchTo": "Ir para",
  "chat.taskPill.tooltipWithBranch": "{label} · {branch}",
  "chat.sessionTabs.moreSessions": "Mais {count} chats",
  "chat.sessionTabs.closeSession": "Fechar chat",
