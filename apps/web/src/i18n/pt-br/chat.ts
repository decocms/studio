...
export const chat = {
  ...
  "chat.taskPill.editing": "Editando: {task}",
  "chat.taskPill.untitled": "Task sem título",
  "chat.taskPill.searchPlaceholder": "Buscar suas tasks…",
  "chat.taskPill.empty": "Nenhuma task encontrada.",
  "chat.taskPill.newTask": "Nova task",
  "chat.newTask.heading": "Descreva sua task",
  "chat.newTask.placeholder": "Descreva o que você quer fazer…",
  "chat.newTask.submit": "Criar task",
  "chat.newTask.orDivider": "ou",
  "chat.newTask.editManually": "Editar manualmente",
  "chat.newTask.manualEditTitle": "Alteração de CMS",
