...
export const taskBoard = {
  ...
  "taskBoard.forum.attention": "Precisa da sua atenção",
  "taskBoard.forum.pickUp": "Continue de onde parou",
  "taskBoard.forum.workspace": "No espaço de trabalho",
  "taskBoard.forum.conversations": "Conversas",
  "taskBoard.forum.mentionHint": "Menções não lidas, mais recentes primeiro",
  "taskBoard.forum.participationHint": "Ordenadas pela sua última participação",
  "taskBoard.forum.activityHint": "Atividades recentes de todos",
  "taskBoard.forum.mentionedYou": "Mencionou você",
  "taskBoard.forum.noReplies": "Comece a conversa",
  "taskBoard.forum.participated": "Você participou {time}",
  ...
  "taskBoard.config.statusApproved": "Aprovado",
  "taskBoard.config.statusArchived": "Arquivado",
  "taskBoard.config.statusBacklog": "Backlog",
  "taskBoard.config.statusMerged": "Implantado",
  ...
  "taskBoard.config.statusPostDeployValidation": "Validação Pós Deploy",
  ...
  "taskBoard.taskDialog.activityReviewVerdictRequested":
    "{reviewer} terminou sem veredito e foi solicitado a registrar um",
  ...
  "taskBoard.taskDetail.breadcrumbTasks": "Tarefas",
  "taskBoard.taskDetail.breadcrumbTask": "Tarefa",
  ...
  "taskBoard.viewControls.addAnotherFilter": "Adicionar outro filtro",
  "taskBoard.viewControls.addFilter": "Adicionar filtro…",
  "taskBoard.viewControls.clear": "Limpar",
  "taskBoard.viewControls.displayLabel": "Opções de exibição",
  "taskBoard.viewControls.filterLabel": "Filtrar",
  "taskBoard.viewControls.is": "é",
  "taskBoard.viewControls.isAnyOf": "é algum de",
  "taskBoard.viewControls.matchCount": "{count} tarefas",
  "taskBoard.viewControls.noMatches": "Nenhum filtro encontrado.",
  "taskBoard.viewControls.removeFilter": "Remover filtro {field}",
  ...
  "taskBoard.taskFilters.projectAny": "Todos os projetos",
  "taskBoard.taskFilters.projectFilterPlaceholder": "Filtrar por projeto…",
  "taskBoard.taskFilters.projectGroupProjects": "Projetos",
  "taskBoard.taskFilters.projectGroupRepos": "Repositórios",
  "taskBoard.taskFilters.projectNoneFound": "Nenhum projeto encontrado.",
  "taskBoard.taskFilters.tagsFilterPlaceholder": "Filtrar por tag…",
  "taskBoard.taskFilters.tagsNoTagsFound": "Nenhuma tag encontrada.",
  "taskBoard.analytics.title": "Análise do quadro de tarefas",
  "taskBoard.analytics.openAnalytics": "Análise",
  "taskBoard.analytics.backToBoard": "Voltar ao quadro",
  "taskBoard.analytics.orgPickerPlaceholder": "Organização",
  "taskBoard.analytics.orgSearch": "Buscar organizações...",
  "taskBoard.analytics.orgEmpty": "Nenhuma organização encontrada.",
  "taskBoard.analytics.orgCurrent": "Esta organização",
