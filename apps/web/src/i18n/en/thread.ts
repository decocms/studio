export const thread = {
  ...
  "thread.publishPopover.failedRevert": "Failed to revert changes",
  ...
  "thread.publishPopover.reverted": "Reverted {name}",
  "thread.publishPopover.revertedField": "Reverted {field}",
  "thread.publishPopover.revert": "Revert",
  "thread.publishPopover.revertAll": "Revert all",
  "thread.publishPopover.revertAllConfirm":
    "Revert every change? This can't be undone.",
  "thread.publishPopover.revertConfirm": "Revert {name}?",
