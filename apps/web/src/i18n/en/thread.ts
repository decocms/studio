export const thread = {
  ...
  "thread.publishPopover.sectionChangedOne": "1 section changed",
  "thread.publishPopover.fieldsChanged": "{count} fields changed",
  "thread.publishPopover.fieldChangedOne": "1 field changed",
  "thread.publishPopover.pageSettingsChanged": "Page settings changed",
  ...
  "thread.analytics.tabUsage": "Usage",
  "thread.analytics.tabErrors": "Errors",
  "thread.analytics.statusRunning": "Running",
  "thread.analytics.statusWaiting": "Waiting",
  "thread.analytics.statusFailed": "Failed",
  "thread.analytics.statusCompleted": "Completed",
  "thread.analytics.kindChat": "Chat",
  "thread.analytics.kindAutomation": "Automation",
  "thread.analytics.kindTask": "Task run",
  "thread.analytics.anyStatus": "Any status",
  "thread.analytics.anyKind": "Any kind",
  "thread.analytics.liveHint": "Updates live",
  "thread.analytics.countRunning": "Running now",
  "thread.analytics.countWaiting": "Waiting on a human",
  "thread.analytics.countFailedHour": "Failed in the last hour",
  "thread.analytics.empty": "No chats yet.",
  "thread.analytics.untitled": "Untitled chat",
  "thread.analytics.colUpdated": "Updated",
  "thread.analytics.colOrg": "Org",
  "thread.analytics.colChat": "Chat",
  "thread.analytics.colKind": "Kind",
  "thread.analytics.colStatus": "Status",
  "thread.analytics.colUser": "User",
  "thread.analytics.colAgent": "Agent",
  "thread.analytics.colCost": "Cost",
  "thread.analytics.colTokens": "Tokens",
  "thread.analytics.costFootnote":
    "Cost is a floor: only OpenRouter-priced turns report USD. Check cost coverage before reading totals.",
} as const;
