export const library = {
  ...
  "library.syncedRepos.addRepo": "Add synced repo",
  "library.syncedRepos.cancel": "Cancel",
  "library.syncedRepos.create": "Create",
  "library.syncedRepos.creating": "Creating…",
  "library.syncedRepos.created": 'Repo synced into "{volume}"',
  "library.syncedRepos.failed": "Something went wrong",
  "library.syncedRepos.nameDialogDescription":
    "{repo} will be kept in sync into this read-only folder.",
  "library.syncedRepos.nameDialogTitle": "Name the synced folder",
  "library.syncedRepos.namePlaceholder": "folder-name",
  "library.syncedRepos.pickerTitle": "Sync a repo into the library",
  "library.syncedRepos.remove": "Stop syncing",
  ...
  "library.syncedRepos.removeTitle": 'Stop syncing "{volume}"?',
  "library.syncedRepos.removed": "Sync removed",
  "library.syncedRepos.syncFailed": "Last sync failed",
