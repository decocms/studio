export const mainPanelTabs = {
  ...
  "mainPanelTabs.e2eTab.toastCheckDeleted": "Check deleted",
  "mainPanelTabs.e2eTab.confirmDeleteCheckTitle": "Delete check?",
  "mainPanelTabs.e2eTab.confirmDeleteCheck":
    "This removes the check and its run history. This can't be undone.",
