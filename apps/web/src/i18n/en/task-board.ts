export const taskBoard = {
  "taskBoard.forum.markReadFailed": "Could not save your reading progress.",
  "taskBoard.forum.forYou": "For you",
  "taskBoard.forum.mentions": "Mentions",
  "taskBoard.forum.unread": "Unread",
  "taskBoard.forum.sort": "Sort conversations",
  "taskBoard.forum.personal": "Personal relevance",
  "taskBoard.forum.latest": "Latest activity",
  "taskBoard.forum.updates": "Show new activity",
  "taskBoard.forum.loadFailed": "Could not load conversations.",
  "taskBoard.forum.retry": "Try again",
  "taskBoard.forum.empty": "No conversations match these filters.",
  "taskBoard.forum.attention": "Needs your attention",
  "taskBoard.forum.pickUp": "Pick up where you left off",
  "taskBoard.forum.workspace": "Around the workspace",
  "taskBoard.forum.conversations": "Conversations",
  "taskBoard.forum.mentionHint": "Unread mentions, newest first",
  "taskBoard.forum.participationHint": "Ordered by your last participation",
  "taskBoard.forum.activityHint": "Latest activity from everyone",
  "taskBoard.forum.mentionedYou": "Mentioned you",
  "taskBoard.forum.noReplies": "Start the conversation",
  "taskBoard.forum.participated": "You participated {time}",
  "taskBoard.forum.participants": "Participants",
  "taskBoard.forum.replyCount": "{count} replies",
  "taskBoard.forum.unreadCount": "{count} unread replies",
  "taskBoard.forum.loadMore": "Load more conversations",
  "taskBoard.forum.newSinceVisit": "New since your last visit",
  "taskBoard.forum.brief": "The brief",
  ...
  "taskBoard.taskDialog.runFailedGithubOwnerOnly":
    "Only an owner of the {owner} GitHub organization can accept the App's new permissions — GitHub shows everyone else a 404. If that isn't you, send them this task.",
  ...
  "taskBoard.taskDialog.copyDescription": "Copy description",
  ...
  "taskBoard.taskDialog.prConflict": "Resolve conflicts before shipping",
  "taskBoard.taskDialog.resolveConflictButton": "Resolve",
  "taskBoard.taskDialog.resolveConflictTitle":
    "This change has conflicts that need resolving before it can ship — the agent will resolve them for you",
  ...
  "taskBoard.taskDialog.labelsLabel": "Labels",
  ...
  "taskBoard.taskDialog.timelineFoldLess": "Show fewer updates",
  ...
  "taskBoard.taskDialog.cloneTitle": "{title} (copy)",
  "taskBoard.taskDialog.cloneSuccess": "Task cloned",
  "taskBoard.taskDialog.archiveTask": "Archive",
  "taskBoard.taskDialog.archiveSuccess": "Task archived",
  ...
  "taskBoard.viewControls.addAnotherFilter": "Add another filter",
  "taskBoard.viewControls.addFilter": "Add filter…",
  "taskBoard.viewControls.clear": "Clear",
  "taskBoard.viewControls.displayLabel": "Display options",
  "taskBoard.viewControls.filterLabel": "Filter",
  "taskBoard.viewControls.is": "is",
  "taskBoard.viewControls.isAnyOf": "is any of",
  "taskBoard.viewControls.matchCount": "{count} tasks",
  "taskBoard.viewControls.noMatches": "No filters found.",
  "taskBoard.viewControls.removeFilter": "Remove {field} filter",
  ...
  "taskBoard.analytics.title": "Task board analytics",
  "taskBoard.analytics.openAnalytics": "Analytics",
  "taskBoard.analytics.backToBoard": "Back to board",
  "taskBoard.analytics.orgPickerPlaceholder": "Organization",
  "taskBoard.analytics.orgSearch": "Search organizations...",
  "taskBoard.analytics.orgEmpty": "No organizations found.",
  "taskBoard.analytics.orgCurrent": "This organization",
