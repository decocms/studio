export const taskBoard = {
  "taskBoard.feed.today": "Today",
  "taskBoard.feed.yesterday": "Yesterday",
  "taskBoard.feed.eventBlocked": "Needs your input",
  "taskBoard.feed.eventHanded": "Handed back to you",
  "taskBoard.feed.eventRunning": "Agent working",
  "taskBoard.feed.eventFailed": "Run failed",
  "taskBoard.feed.eventDone": "Shipped",
  "taskBoard.feed.eventDelivered": "Moved forward",
  "taskBoard.feed.eventReview": "In review",
  ...
  "taskBoard.taskFilters.projectSettingsLabel": "Project settings",
  ...
  "taskBoard.feed.composerPlaceholder": "What needs doing?",
  "taskBoard.feed.composerDescriptionPlaceholder": "Add description...",
  "taskBoard.feed.composerSubmit": "Add",
  "taskBoard.feed.railRunning": "Running now",
  "taskBoard.feed.railWaiting": "Waiting on you",
  "taskBoard.feed.railIdle": "No agents running right now",
} as const;
