export const settings = {
  ...
  "settings.board.title": "Board",
  "settings.board.saved": "Board settings saved",
  "settings.board.saveFailed": "Failed to save board settings",
  "settings.board.columnsTitle": "Columns",
  "settings.board.columnsDescription":
    "Rename, reorder or add board columns. Each column maps to a stage, which is what agent automation follows.",
  "settings.board.resetColumns": "Reset to defaults",
  "settings.board.saveColumns": "Save columns",
  "settings.board.addColumn": "Add column",
  "settings.board.stageLabel": "Stage:",
  "settings.board.moveColumnUpAriaLabel": "Move column up",
  "settings.board.moveColumnDownAriaLabel": "Move column down",
  "settings.board.deleteColumnAriaLabel": "Delete column",
  "settings.board.automationLabel": "Run agent on entry",
  "settings.board.automationSuperAgent": "Super Agent",
  "settings.board.automationAgentUnknown": "Unknown agent",
  "settings.board.featuresTitle": "Features",
  "settings.board.featuresDescription":
    "Optional planning features. Off by default to keep the board simple.",
  "settings.board.sprintsToggle": "Sprints",
  "settings.board.sprintsToggleDescription":
    "Plan work in weekly sprints and filter the board by sprint. Sprints are the calendar weeks — pick one per task, nothing to set up.",
  "settings.board.releasesToggle": "Releases",
  "settings.board.releasesToggleDescription":
    "Group finished tasks into releases from the board.",
