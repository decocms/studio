export const chat = {
  ...
  "chat.agentCreate.createAgent": "Create project",
  "chat.agentCreate.created": "Project created",
  "chat.agentCreate.creating": "Creating project",
  "chat.agentCreate.seeAgent": "See project",
  "chat.agentCreate.seeAgentLabel": "See project: {name}",
  "chat.agentIcons.claudeCode": "Claude Code",
  "chat.agentIcons.codex": "Codex",
  "chat.agentIcons.opencode": "OpenCode",
  "chat.agentList.agentsNoun": "projects",
  "chat.agentList.couldntLoad": "Couldn't load projects",
  "chat.agentList.listAgents": "List projects",
  "chat.agentList.loading": "Loading projects",
  "chat.agentList.multiAgents": "{count} projects",
  "chat.agentList.noAgents": "No projects yet",
  "chat.agentList.noAgentsDesc":
    "This organization hasn't created any projects.",
  "chat.agentList.oneAgent": "1 project",
  "chat.agentList.unavailable": "Project list unavailable",
  ...
  "chat.contextPanel.agentLabel": "Project",
  ...
  "chat.generic.annotation.destructive": "May modify or delete data",
  "chat.generic.annotation.interactive": "Interactive",
  "chat.generic.annotation.openWorld": "Reaches outside this system",
  "chat.generic.annotation.readOnly": "Read-only — no side effects",
  ...
  "chat.generic.tool.enableTool": "Enable Tool",
  "chat.generic.tool.glob": "Find Files",
  "chat.generic.tool.grep": "Search Content",
  "chat.generic.tool.openInAgent": "Open in Project",
  "chat.generic.tool.read": "Read File",
  "chat.generic.tool.readPrompt": "Read Prompt",
  "chat.generic.tool.readResource": "Read Resource",
  "chat.generic.tool.readToolOutput": "Read Tool Output",
  "chat.generic.tool.sandbox": "Run Code",
  "chat.generic.tool.skill": "Load Skill",
  "chat.generic.tool.write": "Write File",
  ...
  "chat.fastPreview.chatNeedsSession":
    "Chat needs a coding sandbox behind it. The session continues on this branch and the CMS keeps working as is.",
  ...
  "chat.input.productionReadOnly": "Production is read-only",
  "chat.input.startDraftToEdit": "Start a new draft to edit",
  ...
  "chat.mentionAt.agentsDescription": "Mention a project to hand off work",
  "chat.mentionAt.agentsTitle": "Projects",
  ...
  "chat.noAiProviderEmptyState.headingDefault":
    "Your projects are almost ready",
  ...
  "chat.selectVirtualMcp.chooseAgentTooltip": "Choose a project to chat with",
  "chat.selectVirtualMcp.createAgent": "Create Project",
  "chat.selectVirtualMcp.creating": "Creating...",
  "chat.selectVirtualMcp.noAgentsFound": "No projects found",
  "chat.selectVirtualMcp.searchPlaceholder": "Search for a project...",
  "chat.selectVirtualMcp.selectAgent": "Select Project",
