export const chat = {
  ...
  "chat.sessionTabs.newSession": "New chat in this task",
  "chat.taskPill.noTask": "No task",
  "chat.taskPill.searchPlaceholder": "Search tasks...",
  "chat.taskPill.noneFound": "No tasks found.",
  "chat.taskPill.addThisChat": "Add this chat to the board",
  "chat.taskPill.switchTo": "Switch to",
  "chat.taskPill.tooltipWithBranch": "{label} · {branch}",
  "chat.sessionTabs.moreSessions": "{count} more chats",
  "chat.sessionTabs.closeSession": "Close chat",
