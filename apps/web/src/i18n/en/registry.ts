export const registry = {
  ...
  "registry.imageUpload.failedToGetPresignedUrl": "Failed to get presigned URL",
  "registry.imageUpload.failedToGetPublicUrl": "Failed to get public URL",
  ...
  "registry.imageUpload.onlyImageFiles": "Only image files are supported",
  ...
  "registry.imageUpload.sizeTooLarge": "Image size must be less than 5MB",
  "registry.imageUpload.supportedFormats": "PNG, JPG, SVG up to 5MB",
  "registry.imageUpload.uploadFailed": "Upload failed: {statusText}",
