export const devAgent = {
  ...
  "devAgent.devAgentSetup.importDialogTitle": "Import a development repository",
  "devAgent.devAgentSetup.linkDescription":
    "Link a repository-backed dev project. Its sandbox dev server powers a Develop/Live toggle so you can develop and test this project's MCP app.",
  "devAgent.devAgentSetup.linkedDescription":
    "Linked dev project — its sandbox dev server powers the Develop/Live toggle in the header.",
