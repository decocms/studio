/**
 * Pure derivation of Reports diagnostic state from
 * `get_my_diagnostic` (Reports's owner view). Kept UI-free so the
...
export type ReportBannerStatus = "generating" | "ready" | "none";

export function deriveReportBannerStatus(
...
/**
 * Whether {@link useReportsDiagnostic} should still report `isLoading`. A
 ...
 */
export function isReportsDiagnosticLoading(
