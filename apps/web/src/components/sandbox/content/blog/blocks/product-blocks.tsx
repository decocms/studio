    ...
    >
      <div className="relative aspect-square">
        ...
        <button
          ...
          {...attributes}
          {...listeners}
          className="absolute left-1 top-1 flex h-6 w-6 cursor-grab items-center justify-center bg-background/80 text-muted-foreground opacity-0 backdrop-blur-sm transition-opacity hover:text-foreground active:cursor-grabbing group-hover/card:opacity-100 rounded-lg"
        >
          <DotsGrid size={13} />
        </button>
        <button
          ...
          onClick={onRemove}
          className="absolute right-1 top-1 flex h-6 w-6 items-center justify-center bg-background/80 text-muted-foreground opacity-0 backdrop-blur-sm transition-opacity hover:text-destructive group-hover/card:opacity-100 cursor-pointer rounded-lg"
        >
          <XClose size={13} />
        </button>
      </div>
