  ...
  return (
    ...
    >
      <button
        ...
        className="absolute left-1 top-1.5 flex h-6 w-6 cursor-grab items-center justify-center rounded-lg text-muted-foreground opacity-0 transition-opacity hover:bg-muted hover:text-foreground active:cursor-grabbing group-hover/row:opacity-100"
        {...attributes}
        {...listeners}
      >
        <DotsGrid size={14} />
      ...
      <div className="absolute right-1 top-1 z-10 flex flex-row gap-0.5 rounded-md bg-background/80 opacity-0 backdrop-blur-sm transition-opacity group-hover/row:opacity-100">
        <button
          ...
          onClick={onDuplicate}
          className="flex h-6 w-6 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground cursor-pointer"
        >
          <Copy01 size={14} />
        </button>
        <button
          ...
          onClick={onDelete}
          className="flex h-6 w-6 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-destructive cursor-pointer"
        >
          <Trash01 size={14} />
        </button>
      </div>
