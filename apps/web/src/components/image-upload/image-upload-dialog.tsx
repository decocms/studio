                    ...
                    <div key={item.path} className="group relative">
                      ...
                      {gallery.onDelete && !item.current ? (
                        <button
                          ...
                          className="absolute -right-1 -top-1 hidden classic:rounded-full compact:rounded-lg bg-background p-1 text-muted-foreground shadow-sm hover:text-destructive group-hover:block"
                        >
