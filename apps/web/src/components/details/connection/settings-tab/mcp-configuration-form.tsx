...
import { VirtualMCPSelector } from "@/components/chat/select-virtual-mcp";
        ...
        {(onAddNew || canInstallInline) && (
          <div className="border-t border-border">
            <Button
              ...
              variant="ghost"
              className="w-full justify-start gap-2 px-2 py-2 h-auto hover:bg-muted text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              type="button"
            >
              {isInstalling ? (
                <>
