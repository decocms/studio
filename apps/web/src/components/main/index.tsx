...
function MainTopbar({
  ...
  return (
    <header
      ...
      className={cn(
        "@container [container-name:main-topbar_panel-header] relative z-10 grid shrink-0 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 border-transparent px-1.5",
        className,
      )}
    >
      {children}
