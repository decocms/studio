...
export function ModelSelector({
  ...
  const triggerButton = (
    <Button
      ...
      size="sm"
      className={cn(
        "text-sm hover:bg-accent classic:rounded-lg py-0.5 px-1 gap-1 shadow-none cursor-pointer border-0 group focus-visible:ring-0 focus-visible:ring-offset-0 min-w-0 shrink justify-start overflow-hidden",
