...
import * as migration164commercediscoveryexposealltools from "./164-commerce-discovery-expose-all-tools.ts";
...
const migrations: Record<string, Migration> = {
  ...
  "164-commerce-discovery-expose-all-tools":
    migration164commercediscoveryexposealltools,
};
