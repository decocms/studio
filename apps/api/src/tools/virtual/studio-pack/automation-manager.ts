...
1. Suggesting automations from existing agents (first-contact default):
   ...
   b. If no custom agents exist, tell the user they need to create one first — ask the Super Agent to build it. Do not propose automations against the Studio Pack agents.
