...
export const CORE_TOOLS = [
  ...
  TaskBoardTools.TASK_BOARD_SUBSCRIPTION_GET,
  TaskBoardTools.TASK_BOARD_SUBSCRIPTION_SET,
  TaskBoardTools.TASK_BOARD_INBOX_LIST,
  TaskBoardTools.TASK_BOARD_INBOX_MARK_READ,
