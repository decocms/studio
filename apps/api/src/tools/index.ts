...
export const CORE_TOOLS = [
  ...
  TaskBoardTools.TASK_BOARD_ATTACHMENT_ADD,
  TaskBoardTools.TASK_BOARD_ATTACHMENT_LIST,
  TaskBoardTools.TASK_BOARD_ATTACHMENT_DELETE,
  ...
  TaskBoardTools.TASK_BOARD_RELEASE_CREATE,
  TaskBoardTools.TASK_BOARD_RELEASE_LIST,
  TaskBoardTools.TASK_BOARD_RELEASE_DELETE,
