 ...
 * consumption — the sole liveness heartbeat for hosted runs. Dispatch-run.ts
 * no longer has its own tap because its wrapped stream never enqueued a chunk.
 * Without this projector tap the reaper's
