/**
 * E2E: the Reports report banner on the PROJECT home (Overview).
 *
 ...
 * well-known Reports connection id. Wire-contract strings
 ...
 *  (WellKnownOrgMCPId.REPORTS) and the report tool name. */
